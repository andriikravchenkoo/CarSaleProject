...
public class UserServiceImpl implements UserService {
  ...
  public User findByDealershipId(Long id) {
    return userDao
        .findByDealershipId(id)
        .orElseThrow(
            () -> new ResourceNotFoundException("User by dealership id = " + id + " not found"));
  }
  ...
  public User findByAnnouncementId(Long id) {
    return userDao
        ...
        .orElseThrow(
            () -> new ResourceNotFoundException("User by announcement id = " + id + " not found"));
  }
