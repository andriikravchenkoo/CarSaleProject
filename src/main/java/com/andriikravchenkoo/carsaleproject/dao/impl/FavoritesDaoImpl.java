...
public class FavoritesDaoImpl implements FavoritesDao {
    ...
    public Favorites save(Favorites favorites) {
        final String SQL = "INSERT INTO favorites (user_id, announcement_id) VALUES (:user_id, :announcement_id)";
    ...
    public void delete(Favorites favorites) {
        final String SQL = "DELETE FROM favorites WHERE user_id = :user_id AND announcement_id = :announcement_id";
        SqlParameterSource sqlParameterSource = new MapSqlParameterSource()
                .addValue("user_id", favorites.getUserId())
                .addValue("announcement_id", favorites.getAnnouncementId());
    ...
    public Long checkExistence(Favorites favorites) {
        final String SQL = "SELECT COUNT(*) FROM favorites WHERE user_id = :user_id AND announcement_id = :announcement_id";
        SqlParameterSource sqlParameterSource = new MapSqlParameterSource()
                .addValue("user_id", favorites.getUserId())
                .addValue("announcement_id", favorites.getAnnouncementId());
